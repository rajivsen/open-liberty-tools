...
import com.ibm.etools.liberty.integration.common.servertype.internal.AbstractLibertyBuildPluginJEEPublisher;
...
public class LibertyMavenJEEPublisher extends AbstractLibertyBuildPluginJEEPublisher {
    ...
    protected void publishOnParent(WebSphereServer wsServer, IProject moduleProject, LibertyMavenConfiguration config,
        ...
        if (parentPath != null) {
            ...
            // TODO: need to talk with Patrick to find out what is expected in this situation.
            // To prevent this scenario from blocking the non-loose EAR support, it will fail
            // silently for now
            return;
        }
